...
import github.jcsmecabricks.customweapons.init.worldgen.ConfiguredFeatureInit;
import github.jcsmecabricks.customweapons.init.worldgen.PlacedFeatureInit;
...
public class CustomWeaponsDataGenerator implements DataGeneratorEntrypoint {
	...
	public void onInitializeDataGenerator(FabricDataGenerator fabricDataGenerator) {
		...
		pack.addProvider(CustomWeaponsEnglishLanguageProvider::new);
