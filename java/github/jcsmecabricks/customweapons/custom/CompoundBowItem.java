...
public class CompoundBowItem extends BowItem {
    ...
    public static void registerModelPredicates() {
        registerCustomBow(ItemInit.COMPOUND_BOW);
    }
    ...
    public int getEnchantability() {
        return 20; // Same as a regular bow, adjust as needed
    }
    ...
    public float call(ItemStack stack, net.minecraft.world.World world, net.minecraft.entity.LivingEntity entity, int seed) {
        if (entity == null) {
            return 0.0F;
        }
        ...
        if (entity.getActiveItem() == stack) {
            ...
            return (float) useTime / 20.0F; // Normalize the value to a float between 0 and 1
        }
