...
import github.jcsmecabricks.customweapons.enchantments.effects.LightningEnchantmentEffect;
...
public class EnchantmentInit {
    public static final RegistryKey<Enchantment> BOLTING_ENCHANTMENT_KEY = RegistryKey.of(RegistryKeys.ENCHANTMENT, CustomWeapons.id("bolting"));
